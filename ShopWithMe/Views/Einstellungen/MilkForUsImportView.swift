        ...
        VStack(spacing: 16) {
            if laedt {
                ...
                ContentUnavailableView {
                    ...
                    Text("Wähle eine aus MilkForUs exportierte Textdatei — Artikel und Kategorien werden automatisch mit deinem Bestand abgeglichen.")
                } actions: {
    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Kategorie antippen, um sie einer bestehenden Kategorie oder „Sonstiges“ zuzuordnen, statt eine neue anzulegen. Nicht benötigte Artikel nach links wischen.")
            }
        }
...
private struct KategorieZuordnungsMenu: View {
    ...
    var body: some View {
        Menu {
            ...
            HStack {
                Text(gruppe.kategorieName.isEmpty ? "Ohne Kategorie" : gruppe.kategorieName)
